const generateInvitationEmailTemplate = (data) => {
  const {
    recipientName,
    inviterName,
    inviterEmail,
...
<body>
    <div class="email-container">
        ...
        <div class="content-section">
            <h1 class="greeting">Hi ${recipientName},</h1>
            
            <p class="message">
                You have been invited by the admin of the <span class="organization-name">${organizationName}</span> to join their organization. Click below to either accept or reject the invitation.
            </p>

            <a href="${invitationLink}" class="cta-button">View Invitation</a>
 ...
 */
const generateInvitationTextTemplate = (data) => {
  const {
    recipientName,
    inviterName,
    organizationName,
...
You have been invited by the admin of the ${organizationName} to join their organization. Click below to either accept or reject the invitation.

${invitationLink}

This invitation will expire in ${expiryDays} days.

If you have any trouble in accepting the invitation or if you think that you've received this email by mistake, please contact support@tickettracker.com.

Regards,
The Ticket Tracker Team
www.tickettracker.com
...
This e-mail is generated from Ticket Tracker. If you think this is SPAM, please report to abuse@tickettracker.com for immediate action.
  `.trim();
};
