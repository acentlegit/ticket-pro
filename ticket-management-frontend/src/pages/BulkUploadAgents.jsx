...
const BulkUploadAgents = () => {
    ...
    const handleDownloadTemplate = async () => {
        try {
            const response = await api.get('/agents/bulk-upload/template', {
                responseType: 'blob'
            });
            ...
            link.href = url;
            link.setAttribute('download', 'agent-upload-template.csv');
    ...
    const downloadErrorReport = () => {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.setAttribute('download', 'agent-bulk-upload-errors.csv');
        document.body.appendChild(link);
        link.click();
        link.remove();
    };
            ...
            <div className="max-w-5xl mx-auto p-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                        ...
                        <li>Fill in agent details (First Name, Last Name, and Email are required)</li>
                        <li>Upload the completed file</li>
                        <li>Review the results and fix any errors if needed</li>
                        <li>Invitation emails will be sent to all successfully created agents</li>
                    </ol>
                    ...
                    >
                        ...
                        {isDragActive ? (
                            ...
                            <>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Maximum file size: 10MB | Maximum rows: 500
                                </p>
                            </>
                        )}
                    </div>
...
export default BulkUploadAgents;
